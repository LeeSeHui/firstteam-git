...
const mockData = {
  '오늘': [
    ...
    },
    {
      ...
      group: 'BLACKPINK',
      type: 'notice',
      title: '📣 BLACKPINK WORLD TOUR 운영 안내',
  ...
  '어제': [
    {
      ...
      group: 'G-DRAGON',
      type: 'media',
      title: '📺 G-DRAGON - ‘TOO BAD’ MV Behind the Scenes',
    ...
    },
    {
      ...
      group: 'BLACKPINK',
      type: 'notice',
      title: '📣 BLACKPINK WORLD TOUR 당첨자 안내',

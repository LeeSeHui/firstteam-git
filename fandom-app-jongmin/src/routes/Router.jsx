...
// 기타
import IdolAlart from '../pages/Alart/IdolAlart';
import ActorAlart from '../pages/Alart/ActorAlart'
import TrotAlart from '../pages/Alart/TrotAlart'
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/idolalart" element={<IdolAlart />} />
        <Route path="/actoralart" element={<ActorAlart />} />
        <Route path="/trotalart" element={<TrotAlart />} />

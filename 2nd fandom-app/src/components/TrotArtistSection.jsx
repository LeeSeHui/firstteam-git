...
import './TrotArtistSection.css';
import '../index.css';
import { useNavigate } from 'react-router-dom';

import likeIcon from '../assets/trot/home/like.png';
import noLikeIcon from '../assets/trot/home/nolike.png';
import commentIcon from '../assets/trot/home/comment.png';
import tagIcon from '../assets/artist/tag.png';
import tagActiveIcon from '../assets/trot/home/tag-blue.png';
      ...
      <div className="feed-card" onClick={() => setIsExpanded(!isExpanded)}>
        ...
        <div className="post-footer">
          <div className="like-counts">
            ...
            <span>
              <img src={commentIcon} alt="댓글" className="icon-small" />3K+
            </span>
          </div>
        </div>
...
export default TrotArtistSection;

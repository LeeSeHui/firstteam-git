...
import './ActorArtistSection.css';
import '../index.css';
import { useNavigate } from 'react-router-dom';

import likeIcon from '../assets/actor/home/like.png';
import noLikeIcon from '../assets/actor/home/nolike.png';
import commentIcon from '../assets/actor/home/comment.png';
import tagIcon from '../assets/artist/tag.png';
import tagActiveIcon from '../assets/actor/home/tag-blue.png';
...
const ActorArtistSection = ({
  ...
  return (
    <div className={`artistSection ${isExpanded ? 'expanded' : ''}`}>
      {/* ✅ 피드 카드 */}
      <div className="feed-card actor_feedCard" onClick={() => setIsExpanded(!isExpanded)}>
...
export default ActorArtistSection;

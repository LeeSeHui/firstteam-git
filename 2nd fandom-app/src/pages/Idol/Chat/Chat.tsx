...
const recommendArtists: RecommendItem[] = [
  ...
  return (
    <div className="chat-page">
          ...
          <div className="profile-slider">
            {profileData.map((artist, i) => (
              <div
                ...
                key={i}
                onClick={() => navigate(`/chatroom/${artist.name.toLowerCase()}`)}
      ...
      <div className="search-box">
        <img src={isDarkMode ? dark_search : search} alt="검색" />
          ...
          >
            ...
            <div className="artist-info">
              <p className="artist-name2">
                {a.name} <img src={check_icon} alt="인증" className="check-icon" />
              </p>

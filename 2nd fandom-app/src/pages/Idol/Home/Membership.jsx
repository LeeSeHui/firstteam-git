    ...
    <div className="membership-wrap">
      ...
      <div className="membership-title">
        <div className="text">
          ...
          <p className="img"><img src={character} alt="멤버십 이미지" /></p>
        </div>
      </div>
      ...
      <div className="note">
        ...
        <ul>
          ...
          <li>[결제/갱신] 자동으로 DM 전용 메시지를 정기 결제하는 상품입니다. 매월 정기 결제에 동의한 경우에만 결제가 가능합니다.</li>
          <li>[결제/갱신] 결제 및 구독 정산은 Apple App Store 정책에 따라 관리되며, 상세 일정(또는 만료 예정일)은 다음 경로에서 확인할 수 있습니다. (앱 &gt; DM &gt; 이용권 관리)</li>
          <li>[해지] 구독해지는 Apple App Store에서 가능하며 App Store 정책에 따라 해지/환불 처리됩니다. 해지 신청 후에는 구독 기간 만료일까지 서비스 이용이 유지되며, 구독 중인 이용권의 부분 환수/부분 환불은 불가합니다.</li>
        </ul>
